...
module Bot
  ...
  # Create the bot
  # The bot is created as a constant, so that we can access the cache anywhere.
  ...
  # @param path [String] the path underneath 'src/modules' to load the files from
  ...
  load_modules(:DiscordRoles, 'roles')
